...
const List<Archetype> allArchetypes = [
  Archetype(
    ...
    skills: [
      ...
      Skill(levelRequirement: 24, name: 'Chacina', description: 'Para cada inimigo acertado no ataque em área voce recebe 1/3 do seu nivel em graus do seu poder principal( Pode ser dano, manipulação, gravidade etc.)'),
      ...
      Skill(levelRequirement: 32, name: 'Camper', description: 'O personagem pode givar graus de alcance para receber metade do que perdeu de acerto por grau givado.'),
      ...
      Skill(levelRequirement: 32, name: 'Esguio', description: 'Recebe seu nivel mais 1/4 do seu alcance em bloqueio/esquiva.'),
    ],
  ),
  Archetype(
    name: 'Lutador',
  ...
  Archetype(
    ...
    skills: [
      ...
      Skill(levelRequirement: 8, name: 'Força do Conhecimento', description: 'Recebe 1 ataque a mais a cada 5 de carisma, vontade ou Inteligencia.'),
      Skill(levelRequirement: 8, name: 'Multiclasse5', description: 'Pode escolher o nv 5 de outro arquetipo.'),
      ...
      Skill(levelRequirement: 16, name: 'Multiclasse10', description: 'Pode escolher o nv 10 de outro arquetipo.'),
      Skill(levelRequirement: 16, name: 'Gênio', description: 'Pode escolher 1/3 do nivel de pericias e trocar o tributo principal delas por inteligencia carisma ou vontade.'),
      ...
      Skill(levelRequirement: 24, name: 'Multiclasse15', description: 'Pode escolher o nv 15 de outro arquetipo.'),
      ...
      Skill(levelRequirement: 32, name: 'Multiclasse20', description: 'Pode pegar a habilidade nv 15 ou 20 de outro arquetipo.'),
