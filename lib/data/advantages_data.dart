...
List<Advantage> allAdvantages = [
  ...
  Advantage(name: 'Ataque Brutal', description: 'Recebe 1 grau dano a mais para cada 2 de acerto que superou a defesa do alvo.'),
  ...
  Advantage(name: 'Esquiva Natural', description: 'Permite somar 1/3+ 2 do nível em esquiva'),
  ...
  Advantage(name: 'Estilo de 1 arma', description: 'Caso voce esteja usando apenas uma arma e nenhuma armadura, seu passo de dano aumenta em 1 e sua margem de critico e seu multiplicador aumentam em 1. '),
  ...
  Advantage(name: 'Fator de Cura Aprimorado', description: 'Sempre que você é curado ou cura alguem você cura o valor total do dado ao inves de precisar rolar.'),
  ...
  Advantage(name: 'Ler Movimentos', description: 'pode usar sua reação para receber seu nivel no bloqueio no ataque. 1 ataque por rodada.'),
  ...
  Advantage(name: 'Mestre em Pericias', description: 'A cada 2 pericias que voce tiver que seus bonus forem maiores que seu nivel voce recebe 1 dado de sorte por sessão.'),
  Advantage(name: 'Mutação', description: 'O personagem não possui o poder de nenhum dos pais tendo recebido ele por experimentos ou outras formas. Assim recebendo 40 de xp extra por nivel Personagens com Mutação Não podem ter aumentar atributo nem bestiário mistico.'),
  ...
  Advantage(name: 'Sherlock Holmes', description: 'Você pode somar sua inteligência em Procurar, Intuição e Rastrear.'),
